...
test('OpenCode synchronizer preserves the title assigned when WindCli creates a session', { concurrency: false }, async () => {
  ...
  try {
    // Both provider-owned values differ from the WindCli title so either one
