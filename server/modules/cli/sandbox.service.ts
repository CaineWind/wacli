...
function showSandboxHelp(output: CliOutput): void {
  output.log(`
${terminalTextStyles.bright('WindCli Sandbox')} — Run WindCli inside Docker Sandboxes
...
Subcommands:
  ...
  ${terminalTextStyles.bright('logs')}         Show WindCli server logs
    ...
    async execute(argumentsList) {
      ...
      switch (options.subcommand) {
        ...
        case 'start': {
          ...
          dependencies.output.log(`${terminalTextStyles.info('▶')} Launching WindCli web server...`);
          dependencies.runSandboxCommand([
            'exec',
            sandboxName,
            'bash',
          ...
          dependencies.output.log(`\n${terminalTextStyles.ok('✔')} ${terminalTextStyles.bright('WindCli is ready!')}`);
        ...
        case 'create': {
          ...
          dependencies.output.log(`\n${terminalTextStyles.bright('WindCli Sandbox')}`);
