...
export function ComposerMenuSurface({
  ...
  return (
    <div
      ...
      className="font-github fixed z-[100] min-w-48 overflow-y-auto overscroll-contain rounded-xl border border-border bg-popover p-1 text-popover-foreground shadow-xl"
      style={{
        right: anchor.right,
